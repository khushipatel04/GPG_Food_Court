...
public class ItemAdp extends RecyclerView.Adapter<ItemAdp.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Glide.with(mContext).load(APIClient.baseUrl + "http://localhost/gpgphp/" + datum.getProductImage()).thumbnail(Glide.with(mContext).load(R.drawable.ezgifresize)).into(holder.imgIcon);
