...
public class CouponAdp extends RecyclerView.Adapter<CouponAdp.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        Glide.with(mContext).load(APIClient.baseUrl + "http://localhost/gpgphp/" + coupon.getCImg()).thumbnail(Glide.with(mContext).load(R.drawable.ezgifresize)).into(holder.imgCode);
