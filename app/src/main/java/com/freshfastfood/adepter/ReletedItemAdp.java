...
public class ReletedItemAdp extends RecyclerView.Adapter<ReletedItemAdp.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Glide.with(mContext).load(APIClient.baseUrl + "http://localhost/gpgphp/" + datum.getProductImage()).thumbnail(Glide.with(mContext).load(R.drawable.lodingimage)).into(holder.imgIcon);
