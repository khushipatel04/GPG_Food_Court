...
public class CategoryAdp extends RecyclerView.Adapter<CategoryAdp.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        Glide.with(mContext).load(APIClient.baseUrl + "http://localhost/gpgphp/" + category.getCatimg()).thumbnail(Glide.with(mContext).load(R.drawable.ezgifresize)).into(holder.thumbnail);
